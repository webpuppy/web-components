...
`,ue=function(t,e,s,i){var n,r=arguments.length,o=r<3?e:null===i?i=Object.getOwnPropertyDescriptor(e,s):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,s,i);else for(var l=t.length-1;l>=0;l--)(n=t[l])&&(o=(r<3?n(o):r>3?n(e,s,o):n(e,s))||o);return r>3&&o&&Object.defineProperty(e,s,o),o};let pe=class extends J{constructor(){super(...arguments),this.size="md"}render(){return N`
        ...
        `}};pe.styles=[ee,de],ue([it()],pe.prototype,"size",void 0),pe=ue([et(Qt.COMPONENT_PREFIX+"txt")],pe);let fe=class extends J{render(){return N`
            <header class="wp-hdr">
                <slot></slot>
            </header>
        `}};fe.styles=[ee,de],fe=ue([et(Qt.COMPONENT_PREFIX+"hdr")],fe);let ve=class extends J{constructor(){super(...arguments),this.size="md"}render(){return this.href?N`
        ...
        `}};ve.styles=[ee,ce,de],ue([it()],ve.prototype,"size",void 0),ue([it()],ve.prototype,"href",void 0),ve=ue([et(Qt.COMPONENT_PREFIX+"tag")],ve);export{i as CSSResult,Jt as Enums,J as LitElement,ie as WPBtn,fe as WPHdr,oe as WPLink,he as WPNav,ve as WPTag,pe as WPTxt,Zt as asyncReplace,Tt as cache,rt as choose,pt as classMap,n as css,et as customElement,Nt as guard,N as html,Pt as ifDefined,kt as keyed,Ut as live,St as map,it as property,Dt as ref,Et as repeat,ft as styleMap,Ft as unsafeHTML,Gt as unsafeSVG,Yt as until,ot as when};
